            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table class="table table-bordered table-striped table-responsive-sm table-hover" v-if="tasks.length > 0">
                            <tbody>
                            <tr>
                                <th>
                                    No.
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-danger" v-if="errors.length > 0">
                            <ul>
                                <li v-for="(data,index) in errors" v-bind:key="index">{{ data }}</li>
                            </ul>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="alert alert-danger" v-if="errors.length > 0">
                            <ul>
                                <li v-for="(data,index) in errors" v-bind:key="index">{{ error }}</li>
                            </ul>
                        </div>
