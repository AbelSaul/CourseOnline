            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <input type="search" v-model="search" placeholder=" What I want to learn?">
                    </div>
                    <div id="app-course" class="animated bounceInLeft">
                        <div v-for="course in searchByName" class="caratula">
                          ...
                          <button @click="addCourse(course.id)" class="btn btn-success btn-xs">Add</button>       
                        </div>           
                    </div>
              </div>
           </div>
...
export default{
  data() {
    ...
    computed: {
        ...
        return this.courses.filter((search) => search.name.includes(this.search))
    }
  }
}
</script>
